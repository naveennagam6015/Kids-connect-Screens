    ...
    <View style={styles.container}>
      ...
      >
        ...
        >
          ...
          <View style={[styles.messageContainer]}>
            <Text style={styles.message}>Which suject we are going to study today?</Text>
          </View>
          <View style={styles.senderView}>
            <Text style={styles.senderTime}>10:12 PM</Text>
          </View>
        ...
        >
          ...
          <View style={[styles.reciverMessageContainer]}>
            <Text style={styles.message}>vishaaal.... its maths</Text>
          </View>
          <View style={styles.reciverView}>
        ...
        >
          ...
          <View style={[styles.reciverMessageContainer]}>
            <Text style={styles.message}>
              Bring the my notes, dont forgot please
            </Text>
          </View>
          <View style={styles.reciverView}>
