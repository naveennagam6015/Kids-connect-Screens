...
export default function Registration({ navigation, route }) {
  ...
  useEffect(() => {
    navigation.setOptions({ headerTitle: step1 ? "Step 1 of 2" : "Step 2 of 2" });
  }, [step1]);
  ...
  const handleTimeout = () => {
    Alert.alert("Sorry", "The OTP has expired.", [
      {
        text: "Cancel",
        style: "cancel",
        onPress: () => {},
  ...
  const VerifyClick = () => {
    if (enteredOtp == otp) {
      navigation.navigate("ProfileVerification", { email: mail });
    } else {
        ...
        {step1 && (
          <View>
            <View style={[styles.container]}>
              ...
              />
              {!isValidEmail && (
                <TextMedium style={styles.errorText}>
              ...
              {/* </View> */}
              <TextRegular style={[styles.subtext2]}>
                By clicking on this verification code you obey all terms &
                Pocilices and recieve notifications.
              </TextRegular>
            </View>
          </View>
        )}
            ...
            <View style={[styles.container]}>
              ...
              <View style={[styles.flexrow, styles.justiffsb]}>
                <TextInput
                  ...
                  onChangeText={(e) => setEnteredOtp(e)}
                />
              </View>
              <View style={[styles.Buttoncard, styles.Buttoncardwidth]}>
                <Pressable onPress={VerifyClick} style={[styles.flexrow]}>
                  <TextBold style={[styles.btnPrimaryTextsize]}>
                    Verify
                  </TextBold>
                  <MaterialIcons
