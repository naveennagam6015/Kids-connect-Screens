    ...
    <View style={[styles.container]}>
      ...
      <Modal animationType="slide" transparent={true} visible={open}>
        ...
        <View style={[styles.containerbg]}>
          ...
          />
          <TextBold style={{ marginBottom: 16, color: 'red' }}>{lastNameError}</TextBold>
          ...
          />
            <TextBold style={{ marginBottom: 16, color: 'red' }}>{phoneError}</TextBold>
          ...
          />
          <TextBold style={{ marginBottom: 16, color: 'red' }}>{emailError}</TextBold>
          ...
          />
          <TextBold style={{ marginBottom: 16, color: 'red' }}>{relationshipError}</TextBold>
      ...
      >
        <View style={[styles.modalcontainer]}>
          ...
          />
          <TextBold style={{ marginBottom: 16, color: 'red' }}>{dobError}</TextBold>
          ...
          />
          <TextBold style={{ marginBottom: 16, color: 'red' }}>{genderError}</TextBold>
          ...
          />
          <TextBold style={{ marginBottom: 16, color: 'red' }}>{addressError}</TextBold>
          <View style={[styles.flexrow, { justifyContent: "space-between" }]}>
